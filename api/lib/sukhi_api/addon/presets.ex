...
defmodule SukhiApi.Addon.Presets do
  @moduledoc """
  ...
  being handed to `SukhiApi.Registry`.

  KEEP IN SYNC with `SukhiFedi.Addon.Presets` — the gateway has its own
  copy because it's a separate mix project.
  """
