...
export const ja = {
  ...
  'signup.emailHelp': '6 桁のコードを送って、その場で確認します。これが入り口になります。',
  'signup.emailProven': '確認できました。',
  'signup.emailProofNeeded': '先に、メールの確認を済ませてください。',
  ...
  'login.codeSentNotice': 'コードを送りました。メールを見てください。',
  'login.code': '認証コード（6桁）',
  'login.emailCodeFailed': 'コードが合わないか、期限が切れています。',
