...
export const ko: Dict = {
  ...
  'signup.email': '메일 주소',
  'signup.emailHelp': '6자리 코드를 보내서 바로 확인해요. 이게 입구가 돼요.',
  'signup.emailProven': '확인됐어요.',
  'signup.emailProofNeeded': '먼저 메일 확인을 마쳐 주세요.',
  ...
  'login.codeSentNotice': '코드를 보냈어요. 메일함을 봐 주세요.',
  'login.code': '인증 코드 (6자리)',
  'login.emailCodeFailed': '코드가 맞지 않거나 기한이 지났어요.',
